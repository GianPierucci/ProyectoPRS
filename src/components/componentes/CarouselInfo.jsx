...
const CarouselInfo = () => {
    ...
    return (
        <Carousel width="550px" thumbWidth="50px" interval="3000" infiniteLoop={true} dynamicHeight={true} autoPlay={true} showArrows={false} showStatus={false} showThumbs={false}>
            <div>
